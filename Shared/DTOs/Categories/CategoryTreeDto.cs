namespace PBL3.Shared.DTOs.Categories // Định nghĩa namespace PBL3.Shared.DTOs.Categories quản lý cấu trúc code truyền tải và validator.
{
    ...
    /// </summary>
    public class CategoryTreeDto // Định nghĩa lớp DTO truyền tải dữ liệu CategoryTreeDto.
    {
        ...
        public List<CategoryTreeDto> Children { get; set; } = new(); // Thuộc tính Children kiểu dữ liệu List<CategoryTreeDto> lưu trữ thông tin truyền tải với giá trị mặc định là new().
    }
}
